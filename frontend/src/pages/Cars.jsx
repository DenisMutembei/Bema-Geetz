      ...
      <div className="relative py-16 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-base max-w-xl mx-auto font-body text-lg">
            Choose from our curated fleet of luxury and economy vehicles in Nairobi, Nakuru, Naivasha, and other places
          </p>
        </div>
      </div>

      <div className="max-w-7xl mx-auto">
        <VerificationBanner requiredType="driving_license" />
          ...
          <>
            <div className="flex justify-between items-center mb-6">
              <p className="text-gray-400 text-sm">
                {data.pagination.totalItems} vehicle{data.pagination.totalItems !== 1 ? 's' : ''} available
              </p>

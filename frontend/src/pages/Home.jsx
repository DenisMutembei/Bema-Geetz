    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={HERO_BG} alt="Nairobi skyline" className="w-full h-full object-cover"/>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto" style={{marginTop: '4rem'}}>
          ...
          <div className="fade-in-up" style={{animationDelay:'0.3s'}}>
            <p className="text-gray-300 text-base sm:text-lg max-w-2xl mx-auto mb-10 font-body text-xl leading-relaxed">
              Experience luxury and comfort with Bema Geetz. We offer premium car rentals
              and exquisite accommodations in Kenya's most vibrant cities.
            </p>
          </div>
          ...
          <div className="fade-in-up flex flex-wrap items-center justify-center gap-4 mb-12" style={{animationDelay:'0.5s'}}>
            <Link to="/cars" className="btn-gold px-8 py-3.5 rounded-full font-sans font-semibold text-sm tracking-wider flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10l2 2h2m4-12l4 8h3l1-2"/>
              </svg>
              Car Hire
            </Link>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          {houses.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {houses.map(l => <ListingCard key={l.id} listing={l}/>)}
            </div>
          ) : (
            <div className="text-center py-20 text-gray-500">
              <div className="text-5xl mb-4">🏠</div>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-base mb-8 font-body text-lg">
            Join thousands of satisfied customers who trust Bema Geetz for premium experiences in Nairobi and Nakuru.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/register" className="btn-gold px-8 py-3.5 rounded-full font-semibold text-sm tracking-wider">
              Get Started
            </Link>
            <a href={`https://wa.me/${import.meta.env.VITE_WHATSAPP || '254700000000'}?text=${encodeURIComponent('Hello! I want to learn more about Bema Geetz')}`}
      ...
      <footer className="border-t border-dark-border py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed">Premium car hire & accommodations in Nairobi & Nakuru, Kenya.</p>
          </div>
          <div>
        ...
        <div className="max-w-6xl mx-auto mt-10 pt-6 border-t border-dark-border text-center text-gray-600 text-xs">
          © {new Date().getFullYear()} Bema Geetz Rentals — Redefining Excellence
        </div>
      </footer>
    </div>
  );
